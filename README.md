...
<p>Este es un portal web desarrollado con el framework PHP Laravel, diseñado para ofrecer una plataforma donde se puedan administrar los servicios y recursos de la empresa XYZ. En desarollo....
...
-   Operaciones CRUD (Crear, Leer, Actualizar y Eliminar) utilizando ajax
...
```
git@github.com:cybertcode/SITIO-WEB-PORTAL-DE-NOTICIAS.git
```

ó

```
https://github.com/cybertcode/SITIO-WEB-PORTAL-DE-NOTICIAS.git
```
