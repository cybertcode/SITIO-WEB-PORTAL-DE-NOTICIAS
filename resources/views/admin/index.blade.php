                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('backend/assets/images/faces/face2.jpg') }}"
                                                alt="image" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('backend/assets/images/faces/face5.jpg') }}"
                                                alt="image" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('backend/assets/images/faces/face3.jpg') }}"
                                                alt="image" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('backend/assets/images/faces/face4.jpg') }}"
                                                alt="image" />
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="preview-list">
                            ...
                            <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <img src="{{ asset('backend/assets/images/faces/face8.jpg') }}" alt="image"
                                        class="rounded-circle" />
                                </div>
                                <div class="flex-grow preview-item-content d-flex">
                                    <div class="flex-grow">
                            ...
                            <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <img src="{{ asset('backend/assets/images/faces/face9.jpg') }}" alt="image"
                                        class="rounded-circle" />
                                </div>
                                <div class="flex-grow preview-item-content d-flex">
                                    <div class="flex-grow">
                            ...
                            <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <img src="{{ asset('backend/assets/images/faces/face11.jpg') }}" alt="image"
                                        class="rounded-circle" />
                                </div>
                                <div class="flex-grow preview-item-content d-flex">
                                    <div class="flex-grow">
