<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="#regiones" aria-expanded="false"
                aria-controls="regiones">
                <span class="menu-icon">
                    <i class="mdi mdi-account-convert"></i>
                </span>
            ...
            <div class="collapse" id="regiones">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('admin.departaments.index') }}">Departamentos</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('admin.provinces.index') }}">Provincias</a>
                    </li>
                </ul>
            </div>
        </li>
