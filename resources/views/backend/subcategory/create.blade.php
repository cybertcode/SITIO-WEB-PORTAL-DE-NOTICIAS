        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Registrando subcategoría</li>
                </ol>
            </nav>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="template-demo">
                            <h4 class="card-title" style="float: left;">Registrando subcategoría</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <a href="{{ route('admin.subcategories.index') }}" class="btn btn-danger">Volver</a>
